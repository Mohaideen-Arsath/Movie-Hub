...
import waseem from '../assets/images/photo2.jpg'
import fardeen from '../assets/images/photo3.jpg'
import Arsath from '../assets/images/photo1.png'
const AboutUs = () => {
  return (
    <div>
      ...
      <section className="images">
        <div className="photo">
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <a href="https://github.com/mohaideen-arsath" target="_blank" rel="noopener noreferrer">
              <img src={Arsath} alt="Product Owner" />
            </a>
            <p className="name" style={{ color: 'white', textAlign: 'center', fontSize: '2.5rem' }}>Mohaideen Arsath</p>
          </div>
          <div className="photo__job">
            <p style={{ color: 'white', textAlign: 'center' }}>Frontend Developer</p>
          </div>
        </div>
        <br></br><br></br><br></br>
        ...
        <div className="photo">
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <a href="https://github.com/waseem0605" target="_blank" rel="noopener noreferrer">
              <img className="middle" src={waseem} alt="Art Director" />
            </a>
        ...
        <div className="photo">
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <a href="https://github.com/Fardheen-N" target="_blank" rel="noopener noreferrer">
